-- renewal_month = ended_at's month. For 12-month plans that's the same
-- calendar month as signup, a year later; for 1-month plans it's simply
-- the following month. Toggle via the plan-length dropdown on the page.
SELECT
